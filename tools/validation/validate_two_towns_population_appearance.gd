...
const FARMER_PERSONALITY_PROFILE := preload("res://features/factions/resources/personality_profiles/farmer_communal.tres")
const RAIDER_PERSONALITY_PROFILE := preload("res://features/factions/resources/personality_profiles/raider_predatory.tres")
const COMMON_LAW_PROFILE := preload("res://features/factions/resources/law_profiles/settler_common_law.tres")
const RAIDER_LAW_PROFILE := preload("res://features/factions/resources/law_profiles/raider_challenge_law.tres")
