...
func _do_initialize() -> void:
	...
	inventory_controller = _context.require(PartyInventoryController.SERVICE_ID) as PartyInventoryController
	humanoid_details_controller = _context.require(HumanoidDetailsController.SERVICE_ID)
