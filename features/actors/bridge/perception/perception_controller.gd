...
func _try_initialize() -> void:
	...
	if _context == null:
		return
	if world_time == null:
		world_time = _context.get_optional(WorldTimeController.SERVICE_ID) as WorldTimeController
	if day_night_lighting == null:
		day_night_lighting = _context.get_optional(DayNightLightingController.SERVICE_ID) as DayNightLightingController
