...
## Independent furnish-pass proving scene: instantiates the medium wood hall
...
const SHELL_SCENE := preload("res://features/world/projection/buildings/shells/modular/medium_wood_hall.tscn")
