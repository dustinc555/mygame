...
const ACTOR_SYNC_SYSTEM_SCRIPT_PATH := "res://src/actors/sim/game_actor_sync_system.gd"
const AI_JOB_SYSTEM_SCRIPT_PATH := "res://src/ai/sim/game_ai_job_system.gd"
const COMBAT_STATE_SYNC_SYSTEM_SCRIPT_PATH := "res://src/combat/sim/game_combat_state_sync_system.gd"
const COMBAT_TARGETING_SYSTEM_SCRIPT_PATH := "res://src/combat/sim/game_combat_targeting_system.gd"
const COMBAT_SLOT_SYSTEM_SCRIPT_PATH := "res://src/combat/sim/game_combat_slot_system.gd"
const COMBAT_RESOLUTION_SYSTEM_SCRIPT_PATH := "res://src/combat/sim/game_combat_resolution_system.gd"
const COMBAT_MOVEMENT_SYSTEM_SCRIPT_PATH := "res://src/combat/sim/game_combat_movement_system.gd"
...
const C_FACTION_PATH := "res://src/actors/sim/c_game_actor_faction.gd"
const C_SETTLEMENT_PATH := "res://src/actors/sim/c_game_actor_settlement.gd"
...
const C_AI_SCHEDULE_PATH := "res://src/ai/sim/c_game_ai_schedule.gd"
const C_AI_STATE_PATH := "res://src/ai/sim/c_game_ai_state.gd"
const C_GOAL_INTENT_PATH := "res://src/ai/sim/c_game_goal_intent.gd"
const C_POPULATION_RECORD_PATH := "res://src/world_sim/sim/population/c_game_population_record.gd"
const C_SETTLEMENT_STATE_PATH := "res://src/settlements/sim/c_game_settlement_state.gd"
const C_STAFF_SLOT_PATH := "res://src/settlements/sim/c_game_staff_slot.gd"
const C_STAFF_VACANCY_PATH := "res://src/settlements/sim/c_game_staff_vacancy.gd"
const C_INVENTORY_CONTAINER_PATH := "res://src/inventory/sim/c_game_inventory_container.gd"
const C_ITEM_STACK_PATH := "res://src/inventory/sim/c_game_item_stack.gd"
const C_EQUIPMENT_SLOT_PATH := "res://src/inventory/sim/c_game_equipment_slot.gd"
const C_SETTLEMENT_EVENT_PATH := "res://src/settlements/sim/c_game_settlement_event.gd"
const C_JOB_PROVIDER_PATH := "res://src/settlements/sim/c_game_job_provider.gd"
const C_JOB_PROVIDER_SLOT_PATH := "res://src/settlements/sim/c_game_job_provider_slot.gd"
const C_JOB_WORKER_RECORD_PATH := "res://src/settlements/sim/c_game_job_worker_record.gd"
const C_JOB_CONTRACT_PATH := "res://src/settlements/sim/c_game_job_contract.gd"
const C_JOB_PROVIDER_MEMORY_PATH := "res://src/settlements/sim/c_game_job_provider_memory.gd"
const C_ACTIVITY_POINT_PATH := "res://src/settlements/sim/c_game_activity_point.gd"
const C_ACTIVITY_ASSIGNMENT_PATH := "res://src/settlements/sim/c_game_activity_assignment.gd"
const C_WORLD_TIME_PATH := "res://src/world_sim/sim/c_game_world_time_state.gd"
const C_LAW_ORDER_PATH := "res://src/settlements/sim/c_game_law_order_state.gd"
const C_FACTION_STATE_PATH := "res://src/world_sim/sim/c_game_faction_state.gd"
const C_WORLD_SQUAD_PATH := "res://src/world_sim/sim/c_game_world_squad_state.gd"
const C_WORLD_EVENT_PATH := "res://src/world_sim/sim/c_game_world_event_state.gd"
const C_NEST_STATE_PATH := "res://src/world_sim/sim/c_game_nest_state.gd"
const C_JOB_SYSTEM_PATH := "res://src/settlements/sim/c_game_job_system_state.gd"
const C_LEDGER_SIMULATION_PATH := "res://src/world_sim/sim/c_game_ledger_simulation_state.gd"
const C_AI_SCHEDULER_STATE_PATH := "res://src/ai/sim/c_game_ai_scheduler_state.gd"
const C_POPULATION_REALIZATION_STATE_PATH := "res://src/world_sim/sim/population/c_game_population_realization_state.gd"
const C_COMBAT_CONFIG_PATH := "res://src/combat/sim/c_game_combat_config.gd"
const C_COMBAT_STATE_PATH := "res://src/combat/sim/c_game_combat_state.gd"
const C_COMBAT_SLOT_STATE_PATH := "res://src/combat/sim/c_game_combat_slot_state.gd"
const C_COMBAT_ACTION_PATH := "res://src/combat/sim/c_game_combat_action.gd"
const C_MOVEMENT_STATE_PATH := "res://src/actors/sim/c_game_movement_state.gd"
const C_WORLD_SIM_SQUAD_PATH := "res://src/world_sim/sim/c_game_world_sim_squad.gd"
...
func register_actor(actor: Node, settlement_id := "", context: Dictionary = {}) -> String:
	...
	if entity == null or not is_instance_valid(entity):
		...
		world.add_entity(entity, [C_NODE.new(), C_IDENTITY.new(), C_FACTION.new(), C_SETTLEMENT.new(), C_SPATIAL.new(), C_VITALS.new(), C_AI_SCHEDULE.new(), C_AI_STATE.new(), C_GOAL_INTENT.new(), C_COMBAT_CONFIG.new(), C_COMBAT_STATE.new(), C_COMBAT_SLOT_STATE.new(), C_COMBAT_ACTION.new(), C_MOVEMENT_STATE.new()])
...
func _ensure_actor_combat_components(entity) -> void:
	if entity == null or not is_instance_valid(entity):
		return
	for component_script in [C_COMBAT_CONFIG, C_COMBAT_STATE, C_COMBAT_SLOT_STATE, C_COMBAT_ACTION, C_MOVEMENT_STATE]:
...
func _load_gecs_scripts() -> bool:
	if _world_script != null and _entity_script != null and _ecs_script != null and _gecs_io_script != null and _actor_sync_system_script != null and _ai_job_system_script != null and _combat_state_sync_system_script != null and _combat_targeting_system_script != null and _combat_slot_system_script != null and _combat_resolution_system_script != null and _combat_movement_system_script != null and _component_scripts_loaded():
		return true
	...
	return _world_script != null and _entity_script != null and _ecs_script != null and _gecs_io_script != null and _actor_sync_system_script != null and _ai_job_system_script != null and _combat_state_sync_system_script != null and _combat_targeting_system_script != null and _combat_slot_system_script != null and _combat_resolution_system_script != null and _combat_movement_system_script != null and _component_scripts_loaded()
