...
const INVENTORY_WINDOW_SCENE = preload("res://src/ui/projection/inventory_window.tscn")
const WORLD_ITEM_SCENE = preload("res://src/world/projection/items/world_item.tscn")
const CURSOR_ITEM_DRAG_SOURCE_SCRIPT = preload("res://src/ui/projection/cursor_item_drag_source.gd")
