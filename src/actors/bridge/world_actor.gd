...
const ACTOR_SKILL_SET_SCRIPT = preload("res://resources/skills/actor_skill_set.gd")
...
const ACTOR_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/actor_capability.gd")
const INVENTORY_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/inventory_capability.gd")
const EQUIPMENT_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/equipment_capability.gd")
const COMBAT_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/combat_capability.gd")
const AI_TARGETING_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/ai_targeting_capability.gd")
const INTERACTION_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/interaction_capability.gd")
const CUSTODY_CAPABILITY_SCRIPT = preload("res://src/actors/bridge/capabilities/custody_capability.gd")
