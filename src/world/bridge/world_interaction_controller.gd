...
const MOVE_COMMAND_INDICATOR_SCENE = preload("res://src/world/projection/effects/move_command_indicator.tscn")
const WORLD_TEXT_NOTICE_SCENE = preload("res://src/world/projection/effects/world_text_notice.tscn")
const PARTY_PORTRAIT_CARD_SCENE = preload("res://src/ui/projection/party_portrait_card.tscn")
