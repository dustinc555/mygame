...
const APPEARANCE_DATA_SCRIPT := preload("res://resources/character_appearance/character_appearance_data.gd")
...
const AI_PATROL_STEP_SCRIPT := preload("res://src/ai/bridge/steps/ai_patrol_step.gd")
const AI_NEST_ASSAULT_STEP_SCRIPT := preload("res://src/ai/bridge/steps/ai_nest_assault_step.gd")
