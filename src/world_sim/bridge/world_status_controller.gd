...
const WORLD_MAP_OVERLAY_SCRIPT = preload("res://src/ui/projection/world_map_overlay.gd")
const LOD_RADIUS_OVERLAY_SCRIPT = preload("res://src/world/projection/lod_radius_overlay.gd")
const DEBUG_MENU_SCRIPT = preload("res://src/ui/projection/debug_menu.gd")
...
func _try_initialize() -> void:
	...
	gecs_world = get_parent().get_node_or_null("GecsWorldController")
	if _debug_enabled():
