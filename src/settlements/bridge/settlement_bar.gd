@tool
extends "res://src/settlements/bridge/settlement_facility_instance.gd"
...
const BAR_SERVICE_AREA_SCRIPT = preload("res://src/settlements/bridge/venues/bar_service_area.gd")
const MERCHANT_HUMANOID_SCRIPT = preload("res://src/actors/projection/humanoid/merchant_humanoid.gd")
const BARBER_HUMANOID_SCRIPT = preload("res://src/actors/projection/humanoid/barber_humanoid.gd")
const MERCHANT_ROLE_SCRIPT = preload("res://src/settlements/bridge/merchant_role.gd")
...
const MERCHANT_PRICE_SCRIPT = preload("res://resources/items/merchant_price.gd")
const MERCHANT_STOCK_SCRIPT = preload("res://resources/items/merchant_stock.gd")
const BAR_GUARD_POST_SCRIPT = preload("res://src/settlements/bridge/venues/bar_guard_post.gd")
const BAR_SERVICE_POINT_SCRIPT = preload("res://src/settlements/bridge/venues/bar_service_point.gd")
const FACILITY_VISIT_POINT_SCRIPT = preload("res://src/settlements/bridge/facility_visit_activity_point.gd")
...
const DEFAULT_BUILDING_SCENE = preload("res://src/world/projection/buildings/bar_scene.tscn")
const TABLE_SCENE = preload("res://src/world/projection/props/bar_table.tscn")
const STOOL_SCENE = preload("res://src/world/projection/props/stool_chair.tscn")
const BED_SCENE = preload("res://src/world/projection/props/simple_bed.tscn")
