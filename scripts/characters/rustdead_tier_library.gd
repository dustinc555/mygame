...
const FRESH := preload("res://resources/character_races/rustdead_tiers/fresh.tres")
const FESTERED := preload("res://resources/character_races/rustdead_tiers/festered.tres")
const WROUGHT := preload("res://resources/character_races/rustdead_tiers/wrought.tres")
const ANCIENT := preload("res://resources/character_races/rustdead_tiers/ancient.tres")
