...
const JAIL_CELL_SCRIPT = preload("res://scripts/world_sim/jail_cell.gd")
const JAIL_CELL_SCENE = preload("res://scenes/world_sim/jail_cell.tscn")
const PRISONER_LOCKER_SCENE = preload("res://scenes/world/containers/prisoner_locker_container.tscn")
