...
const C_ACTOR = preload("res://scripts/benchmark/gecs/components/c_benchmark_actor.gd")
...
const TACTICAL_SYSTEM_SCRIPT = preload("res://scripts/benchmark/gecs/systems/gecs_benchmark_tactical_system.gd")
const MOVEMENT_SYSTEM_SCRIPT = preload("res://scripts/benchmark/gecs/systems/gecs_benchmark_movement_system.gd")
