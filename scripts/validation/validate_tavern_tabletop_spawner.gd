...
const MUG_ITEM := preload("res://resources/items/mug.tres")
...
const BOTTLE_1_ITEM := preload("res://resources/items/bottle_1.tres")
const BOTTLE_2_ITEM := preload("res://resources/items/bottle_2.tres")
const SMALL_BOTTLE_ITEM := preload("res://resources/items/small_bottle.tres")
const CHALICE_ITEM := preload("res://resources/items/chalice.tres")
const TALL_CANDLE_ITEM := preload("res://resources/items/candle_1.tres")
const SHORT_CANDLE_ITEM := preload("res://resources/items/candle_2.tres")
const STUBBY_CANDLE_ITEM := preload("res://resources/items/candle_3.tres")
const CANDLESTICK_ITEM := preload("res://resources/items/candlestick.tres")
